...
public class FormattingServiceTest {
  ...
  public void padValueToTwoDigitsPadsSingleDigit(){
    ...
    assertEquals("Value should have been padded with a leading 0", "02",
        formattingService.padSingleDigitValueToTwoDigits(2));
  }

  @Test
  public void padValueToTwoDigitsDoesNotPadDoubleDigits(){
    //if value is two digits, method should not change it
    assertEquals("Value should be unchanged", "10",
        formattingService.padSingleDigitValueToTwoDigits(10));
  }

  @Test
  public void padValueToThreeDigitsDoesNotPadDoubleDigits() {
    //if value is two digits, method should not change it
    assertEquals("Value should be unchanged", "234",
        formattingService.padSingleDigitValueToTwoDigits(234));
  }
