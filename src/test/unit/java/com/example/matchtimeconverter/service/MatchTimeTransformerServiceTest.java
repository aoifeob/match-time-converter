...
public class MatchTimeTransformerServiceTest {
  ...
  public void transformMatchTimeReturnsInvalid() {
    assertEquals("Result should be invalid", "INVALID",
        matchTimeTransformerService.transformMatchTime("ABC"));
  }

  @Test
  public void transformMatchTime() {
    assertEquals("Result should be invalid", "12:03 - FIRST_HALF",
        matchTimeTransformerService.transformMatchTime("[H1] 12:03.276"));
  }
